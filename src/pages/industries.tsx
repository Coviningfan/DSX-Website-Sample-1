  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-white">
      <section className="mx-auto max-w-6xl px-4 pb-20 pt-36 sm:px-6 sm:pb-24 sm:pt-44 md:px-10">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#0b5ea8]">Industries</p>
              ...
              <div key={industry}>
                ...
                >
                  ...
                  <span className="flex h-11 w-11 items-center justify-center" aria-hidden="true">
                    <ChevronDown className={`h-5 w-5 text-[#c85f1f] transition-transform ${expanded ? "rotate-180" : ""}`} />
                  </span>
                </button>
                {expanded && (
                  <div id={panelId} className="pb-8 pl-[3.25rem] pr-2">
                    {index === 0 ? (
                      <>
                        ...
                        <a href="tel:8443792886" className="mt-8 inline-flex min-h-11 items-center gap-2 font-semibold text-[#0b5ea8] hover:text-[#084b84]">
