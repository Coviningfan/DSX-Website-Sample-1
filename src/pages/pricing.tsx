  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-white">
      <section className="mx-auto max-w-6xl px-4 pb-20 pt-36 sm:px-6 sm:pb-24 sm:pt-44 md:px-10">
        ...
        <p className="mt-5 text-balance text-2xl font-bold text-[#c85f1f] sm:text-3xl">Major Features • Minor Price • Great ROI</p>
      ...
      <section className="bg-[#f6f8fa] px-4 py-20 sm:px-6 sm:py-24 md:px-10">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-2xl font-bold text-[#c85f1f]">Everything after that is pure profit!</p>
          </div>
        </div>
      </section>
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-2 lg:gap-16">
            <article className="border-t-4 border-[#1688e8] pt-7">
              ...
              <p className="mt-5 leading-relaxed text-[#191919]/68">
                Telephone Service is priced based on the concurrent call capacity you need and how you use your phones, not on the number of people, extensions or “lines.”
              </p>
              <p className="mt-6 font-semibold text-[#191919]">We calculate your capacity requirement by looking at:</p>
              <ul className="mt-4 space-y-4">
                {[
                  "What your company does—whether you are a phone-intensive sales organization or a light-phone-use manufacturer.",
                  "The number of people you have, including people in other locations around the country or the world.",
              ...
              <p className="mt-6 leading-relaxed text-[#191919]/68">
                This lets us configure the size of the system you need and estimate the number of concurrent calls you are likely to require—the critical variable and the reason we never use simple per-user or per-seat pricing that results in higher pricing.
              </p>
            </article>

            <article className="border-t-4 border-[#c85f1f] pt-7">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#c85f1f]">AI Services</p>
              ...
              <div className="mt-7 space-y-8">
                <div>
                  ...
                  <p className="mt-3 leading-relaxed text-[#191919]/68">Generally, depending on which and how many business functions you automate, to perfectly match the AI agents to your business.</p>
                </div>
                <div>
                  ...
                  <p className="mt-3 leading-relaxed text-[#191919]/68">A small monthly cost covering AI processing and data storage, generally 15% to 20% of your telephone service charge.</p>
                </div>
              </div>
